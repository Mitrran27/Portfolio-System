...
.nav-section-label {
  ...
  letter-spacing: 0.1em; text-transform: uppercase; padding: 8px 12px 4px;
}
.nav-link-item {
  display: flex; align-items: center; gap: 10px;
...
.nav-link-item.active { color: #22d3ee; background: rgba(34,211,238,0.08); border-left-color: #22d3ee; }
